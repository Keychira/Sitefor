(function ymapsInit(e) {
        ...
        return function(e) {
            ...
            m.prototype = {
                ...
                then: function(e, n, t, r) {
                    var o = new v;
                    return this._addCallbacks(o, e, n, t, r),
                    o.promise()
                },
                "catch": function(e, t) {
                ...
                allPatiently: function(e) {
                    return _.allResolved(e).then(function() {
                        ...
                        for (; u < a; )
                            r = s[u++],
                            o = e[r],
                            _.isRejected(o) ? (n || (n = i ? [] : {}),
                            i ? n.push(o.valueOf()) : n[r] = o.valueOf()) : n || ((t || (t = i ? [] : {}))[r] = _.valueOf(o));
                        if (n)
                            throw n;
                        return t
                    })
    ...
    t.utils = function(e) {
        ...
        return r.nextTick = o.__nextTick__,
    ...
    function() {
        ...
        function n() {
            ...
            try {
                ...
                t || (t = r.getContext(n = "experimental-webgl", o),
                t || (n = null))
            } catch (i) {
                n = null
            }
        ...
        t.supports.graphics = {
            hasSvg: function() {
                return "svg"in i || (i.svg = document.implementation && document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1")),
                i.svg
            },
            hasCanvas: function() {
                if (!("canvas"in i)) {
    ...
    function() {
        ...
        function o() {
            ...
            return o && (e.vendor = r.getParameter(o.UNMASKED_VENDOR_WEBGL).replace(/\W/g, "_"),
            e.renderer = r.getParameter(o.UNMASKED_RENDERER_WEBGL).replace(/\W/g, "_")),
            e
        }
        var i;
        t.supports.vector = {
    ...
    t.modules = new o({
        ...
        fetchBundle: function(e) {
            ...
            o.async = !0;
            var i = t.vow.defer();
            return o.onerror = i.reject.bind(i),
    ...
    function(e) {
        function n() {
            c && (c = !1);
            var e = {};
            arguments.length && (1 != arguments.length || "object" != typeof arguments[0] || arguments[0].length ? "function" != typeof arguments[0] ? (e.require = "string" == typeof arguments[0] ? [arguments[0]] : arguments[0],
            e.successCallback = arguments[1],
            e.errorCallback = arguments[2] && "function" == typeof arguments[2] ? arguments[2] : null,
            e.context = arguments[2] && "object" == typeof arguments[2] ? arguments[2] : arguments[3]) : (e.successCallback = arguments[0],
            e.errorCallback = arguments[1] && "function" == typeof arguments[1] ? arguments[1] : null,
            e.context = arguments[1] && "object" == typeof arguments[1] ? arguments[1] : arguments[2]) : e = arguments[0]);
            var n = e.require || []
              , r = i.all([t.modules.require(n), a, u]).spread(function(e) {
                return t.utils.registerImports(t.ns, n, e),
                t.ns
            });
    ...
    t.modules.define("vectorEngine.loadEngine", ["vow", "Hotspot", "Monitor", "collection.Item", "event.Manager", "hotspot.layer.Hint", "hotspot.layer.optionMapper", "interactivityModel.EventController", "interactivityModel.layer", "option.Manager", "poi.BalloonManager", "util.shapeFactory"], function(e, n) {
        function r() {
            ...
            r.src = t.env.hosts.vectorIndex.replace("{{version}}", t.env.vector.version),
            t.env.vector.filename && (r.src = r.src.replace("vector.min.js", t.env.vector.filename)),
    ...
    "token": "f1be7b11d8e1e3cbd5e35113d3a17a8d",
    ...
    "layers": {
        "map": {
            "version": "24.04.13-0-b240404173730",
            "scaled": true,
        ...
        "sta": {
            "version": "2024.04.12.19.33-1_24.04.12-0-19348"
        },
        "stv": {
            "version": "2024.04.12.19.33-1_24.04.12-0-19348"
        },
