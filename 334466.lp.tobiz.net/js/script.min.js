$((function() {
    ...
    $("body").on("click", ".video_holder", (function() {
        ...
        if ("youtube" == $(this).data("hosting")) {
            i.match(/^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#\&\?]*).*/);
            var e = $(this).data("vid");
            $(this).replaceWith(`<iframe loading=lazy allowfullscreen src="https://www.youtube.com/embed/${e}"></iframe>`)
        } else
            "rutube" != $(this).data("hosting") && "vimeo" != $(this).data("hosting") || $(this).replaceWith('<iframe loading=lazy allowfullscreen src="' + i + '"></iframe>')
    }
    )),
    ...
    $("body").on("touchstart", ".video_holder", (function() {
        ...
        var i = $(this).data("video");
        if ("youtube" == $(this).data("hosting")) {
            var e = i.match(/^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#\&\?]*).*/)
              , t = !(!e || 11 != e[7].length) && e[7];
            $(this).replaceWith('<iframe loading=lazy allowfullscreen src="https://www.youtube.com/embed/' + t + '?autoplay=1"></iframe>')
        } else
            "rutube" != $(this).data("hosting") && "vimeo" != $(this).data("hosting") || $(this).replaceWith('<iframe loading=lazy allowfullscreen src="' + i + '"></iframe>')
    }
    )),
    ...
    $("body").on("click", ".extra_info_block .close", (function() {
        ...
        $(this).parent().parent().siblings().find(".btn1").hasClass("open_card_was") && ($(this).parent().parent().siblings().children(".btn1").addClass("open_card"),
    ...
    $(".section143 .overlay_image_box, .section334 .overlay_image_box, .section144 .overlay_image_box, .section145 .overlay_image_box, .section1144 .overlay_image_box, .section148 .overlay_image_box, .section147 .overlay_image_box, .section313 .overlay_image_box, .section315 .overlay_image_box, .section128 .overlay_image_box, .section1152 .overlay_image_box, .section1153 .overlay_image_box, .section146 .overlay_image_box, .section1145 .overlay_image_box, .section1155 .overlay_image_box, .section2156 .overlay_image_box, .section2157 .overlay_image_box  , .section2158 .overlay_image_box, .section2159 .overlay_image_box  ").size() && $(".section143 .overlay_image_box, .section334 .overlay_image_box, .section144 .overlay_image_box, .section145 .overlay_image_box, .section1144 .overlay_image_box, .section148 .overlay_image_box, .section147 .overlay_image_box, .section313 .overlay_image_box, .section315 .overlay_image_box, .section128 .overlay_image_box, .section1152 .overlay_image_box, .section1153 .overlay_image_box, .section146 .overlay_image_box, .section1145 .overlay_image_box, .section1155 .overlay_image_box, .section2156 .overlay_image_box, .section2157 .overlay_image_box  , .section2158 .overlay_image_box, .section2159 .overlay_image_box  ").click((function() {
        if ("" != $(this).attr("data-link") && "undefined" != $(this).attr("data-link"))
            return 1 == parseInt($(this).attr("data-link-target")) || "_blank" == $(this).attr("data-target") ? window.open($(this).attr("data-link"), "_blank") : window.open($(this).attr("data-link"), "_self"),
            !1
    }
    )),
        ...
        $all_photo.click((function(i) {
            ...
            ($(this).parent().hasClass("item") ? $(this).parent().parent().find(".img_zoom") : $(this).parent().children(".img_zoom")).each((function() {
                ...
                $(this).closest(".section"))
                  , t = i.split("/")
                  , n = "0x900";
                e.hasClass("img_album") && (n = "0x900"),
                e.hasClass("img_portrait") && (n = "600x900"),
                (e.hasClass("img_square") || e.hasClass("square")) && (n = "900x900");
                var o = "/img/" + n + "/" + t[3];
    ...
    $(".section151 .image1").size() && $(".section151 .image1, .section151 .image2, .section151 .image3, .section151 .image4").click((function() {
        if ($(this).closest(".section").hasClass("img_zoom")) {
            var i = "/img/400x560/" + $(this).children().attr("src").split("/")[3];
            $("#img_zoomer_bg").size() && $("#img_zoomer_bg").remove(),
            $("body").append(`<div id="img_zoomer_bg"><img id="img_zoomer" src="${i}" loading="lazy" /><div id="img_zoomer_close" class="portret"></div></div>`)
        }
    }
    )),
    ...
    window.basket = {
        ...
        updateForm: function() {
            if (null !== window.tobiz.basket_conf && void 0 !== window.tobiz.basket_conf && void 0 !== window.tobiz.basket_conf.basket_extra) {
                var i = window.tobiz.basket_conf
                  ...
                  , t = 1
                  , n = "";
                if (void 0 !== i.basket_free_delivery) {
        ...
        formEventListener: function() {
            ...
            $("body").on("click", "#basket_continue", (function(e) {
                i.hideForm()
            }
            )),
        ...
        renderForm: function() {
            ...
            null !== window.tobiz.basket_conf && void 0 !== window.tobiz.basket_conf && void 0 !== window.tobiz.basket_conf.basket_extra) {
                ...
                void 0 !== window.tobiz.basket_conf.basket_continue_shopping && $("#basket_left .btn-group").append('<div id="basket_continue">Продолжить покупки</div>'),
                ...
                void 0 !== window.tobiz.basket_conf.basket_name && $("#basket_right form").append('<div><input type="text" name="user_name"  required="required" placeholder="Введите Имя"/></div>'),
                void 0 !== window.tobiz.basket_conf.basket_redirect && $("#basket_right form").append('<input type="hidden" name="redirect" value="' + window.tobiz.basket_conf.basket_redirect_link + '"  />');
                var s = "";
                if (void 0 !== window.tobiz.basket_conf.basket_mask && void 0 !== window.tobiz.basket_conf.basket_mask_format && (s = window.tobiz.basket_conf.basket_mask_format),
                ...
                void 0 === window.tobiz.basket_conf.hide_email && $("#basket_right form").append('<div><input type="text" name="email" required="required" placeholder="Введите E-mail"/></div>'),
                void 0 !== window.tobiz.basket_conf.basket_fio && $("#basket_right form").append('<div><input type="text" name="fio"  required="required" placeholder="ФИО заказчика"/></div>'),
                void 0 !== window.tobiz.basket_conf.basket_pasport && $("#basket_right form").append('<div><input type="text" name="passport"  required="required" placeholder="Введите паспортные данные"/></div>'),
                void 0 !== window.tobiz.basket_conf.basket_address && $("#basket_right form").append('<div><textarea type="text" name="address"  required="required" placeholder="Адрес доставки"></textarea></div>'),
                void 0 !== window.tobiz.basket_conf.basket_pickup && $("#basket_right form").append('<div><label><input type="checkbox" name="pickup"  value=1 /> Самовывоз (бесплатно) </label></div>'),
                ...
                void 0 !== window.tobiz.basket_conf.basket_comment && $("#basket_right form").append('<div><textarea name="comment" placeholder="Комментарий" ></textarea></div>'),
                void 0 !== window.tobiz.basket_conf.basket_captcha && $("#basket_right form").append('<div><input class="input" type="text" name="norobot" required="required" placeholder="Введите код с картинки"><br><img class="mt-2" src="/captcha.php"></div>'),
    ...
    function silder1160(i, e) {
        ...
        d = "vw") : a > 0 ? (a = 0,
        d = "vw") : a -= 0 + o) : "left" == e && (-r > a - n - o || a > 0 ? (a = 0,
        d = "vw") : a -= 0 + o),
        "right" == e && (a += 0 + o) > 0 && (a = 0,
        d = "vw"),
        i.find(".image_wrapper").css({
    ...
    $("div.btn1, div.btn2, div.btn3, div.btn4,  div.btn5, div.btn6").click((function() {
        ...
        $(this).hasClass("add_basket") && window.tobiz.t >= 3) {
            ...
            null !== window.tobiz.basket_conf && void 0 !== window.tobiz.basket_conf && void 0 !== window.tobiz.basket_conf.do_not_show_when_add || window.basket.showForm(),
    ...
    $(".section.widget").size() && void 0 === window.tobiz.editor && 1 == parseInt(window.tobiz.w)) {
        if ($(".section1000").size()) {
            var popup_1000 = 1;
            $("html").mouseleave((function(i) {
                popup_1000 && (popup_1000 = 0,
        ...
        if ($(".section1003").size() && $(".section1003").show(),
        $(".section1001").size()) {
            var today = new Date;
        ...
        if ($(".section1010").size()) {
            ...
            $(".section1010").each((function() {
                var i = parseInt($(this).data("lag"));
                if (start = parseInt($(this).data("start")),
                ...
                if (today.getHours() >= start && today.getHours() <= stop) {
                    var e = $(this).find(".extra_info_block");
                    setTimeout((function() {
                        e.show(),
                        e.addClass("this_shows")
                    }
                    ), 1e3 * i)
                }
            }
    ...
    SimpleFlexibleTools = {
        renderCSSfromJSON: function(i) {
            ...
            $.each(t.flexblocks, (function(i, a) {
                $.each(["l", "m", "s", "xs", "xxs"], (function(r, d) {
                    void 0 !== a.style[d] && 0 != a.style[d].length || (a.style[d] = {});
                    let l = {};
                    "l" == d && (l = _.extend({}, a.style.l)),
                    "m" == d && (l = _.extend({}, a.style.l, a.style.m)),
                    "s" == d && (l = _.extend({}, a.style.l, a.style.m, a.style.s)),
                    "xs" == d && (l = _.extend({}, a.style.l, a.style.m, a.style.s, a.style.xs)),
                    "xxs" == d && (l = _.extend({}, a.style.l, a.style.m, a.style.s, a.style.xs, a.style.xxs));
                    let c = {};
                    const h = ["l", "m", "s", "xs", "xxs"]
                      , p = h.indexOf(d);
                    for (let i = 0; i <= p; i++) {
                        const e = h[i]
                          , n = _.get(t, `flexblock.style.${e}`);
                        n && (c = _.extend({}, c, n))
                    }
                    void 0 === n[d] && (n[d] = {}),
                    void 0 === n[d][i] && (n[d][i] = ""),
                    void 0 === o[d] && (o[d] = {}),
                    void 0 === o[d][i] && (o[d][i] = ""),
                    void 0 === _.get(c, "height") || s[d] || (s[d] = !0,
                    n[d][i] += `#b_${e} .section_inner{height:${_.get(c, "height")}px}`);
                    let f = SimpleFlexibleTools.buildFlexStyleProperties(l, d, a, !0);
                    f.css_filters && (f.styleContent += `filter: ${f.css_filters};`),
                    f.backdrop_filters && (f.styleContent += `backdrop-filter: ${f.backdrop_filters};`),
                    "" !== f.styleWrapper && (n[d][i] += `#b_${e} .flexblock_wrapper[data-index="${i}"]{${f.styleWrapper}}`),
                    "" !== f.onlyFront && (o[d][i] += `#b_${e} .flexblock_wrapper[data-index="${i}"]{${f.onlyFront}}`),
                    "" !== f.styleContent && (n[d][i] += `#b_${e} .flexblock_wrapper[data-index="${i}"] .flexblock_content{${f.styleContent}}`),
                    "btn" == a.type && ("" != f.styleContent && (n[d][i] += `.modal_bg .flexblock_popup .field .input_flex_btn_${e}_${i}{${f.styleContent}}`),
                    "" !== f.styleHoverContent && (n[d][i] += `.modal_bg .flexblock_popup .field .input_flex_btn_${e}_${i}:hover,#b_${e} .flexblock_wrapper_btn[data-index="${i}"] .flexblock_content:hover{${f.styleHoverContent}}`)),
                    "form" == a.type && ("" !== f.styleFormBtn && (n[d][i] += `#b_${e} .flexblock_wrapper[data-index="${i}"] .flexblock_content input[type="submit"]{${f.styleFormBtn}}`),
                    "" !== f.styleHoverFormBtn && (n[d][i] += `#b_${e} .flexblock_wrapper[data-index="${i}"] .flexblock_content input[type="submit"]:hover{${f.styleHoverFormBtn}}`))
                }
                ))
            }
            ));
            var a = "";
            return $.each(["l", "m", "s", "xs", "xxs"], (function(i, e) {
                let t = "";
                if (_.get(n, e) && $.each(n[e], (function(i, e) {
                    t += e
                }
                )),
                _.get(o, e) && $.each(o[e], (function(i, e) {
                    t += e
                }
                )),
                t && null != typeof t)
                    ...
                    case "l":
                        ...
                        break;
                    case "m":
                        a += `@media (max-width: 1180px){${t}}`;
                        break;
                    case "s":
                        a += `@media (max-width: 1064px){${t}}`;
                        break;
                    case "xs":
                        a += `@media (max-width: 660px){${t}}`;
                        break;
                    case "xxs":
                        a += `@media (max-width: 450px){${t}}`
                    }
            }
            )),
            a = SimpleFlexibleTools.minifyCSS(a)
        },
        minifyCSS: function(i) {
            return i = i.replaceAll(";}", "}").replaceAll(" }", "}").replaceAll('", " ', '","').replaceAll(":0px", ":0").replaceAll(",0.", ",.")
        },
        buildFlexStyleProperties: function(i, e, t, n) {
            let o = ""
              , s = ""
              , a = ""
              , r = ""
              ...
              , c = ""
              , h = "";
            return $.each(i, (function(p, f) {
                if (n) {
                    if (void 0 === t.style[e][p])
                        return;
                    if ("m" == e && t.style.l[p] == f)
                        return;
                    if ("s" == e && t.style.m[p] == f && t.style.l[p] == f)
                        return;
                    if ("xs" == e && t.style.s[p] == f && t.style.l[p] == f)
                        return;
                    if ("xxs" == e && t.style.xs[p] == f && t.style.l[p] == f)
                        return
                }
                if (void 0 !== f && null != f && ("" != f || 0 === f || "none" == f))
                    switch (p) {
                    case "invisible":
                        "1" == _.get(i, "invisible") ? s += "display:none" : s += "display:block";
                        break;
                    case "top":
                        let e = "px";
                        "%" == _.get(i, "topUnit") && (e = "%"),
                        o += `top:${Math.round(parseInt(f), 2)}${e};`;
                        break;
                    case "left":
                        let t = "px";
                        "%" == _.get(i, "leftUnit") && (t = "%"),
                        o += `left:${Math.round(parseInt(f), 2)}${t};`;
                        break;
                    case "width":
                        let n = "px";
                        "%" == _.get(i, "widthUnit") && (n = "%"),
                        o += `width:${Math.round(parseInt(f), 2)}${n};`;
                        break;
                    case "height":
                        let p = "px";
                        "%" == _.get(i, "heightUnit") && (p = "%"),
                        o += `height:${Math.round(parseInt(f), 2)}${p};`;
                        break;
                    case "opacity":
                        o += `opacity:${f};`;
                        break;
                    ...
                    case "animateDuration":
                        s += `--animate-duration:${f};`;
                        break;
                    case "animateEasing":
                        s += `--animate-easing:${f};`;
                        break;
                    case "animateDistance":
                        s += `--animate-distance:${f};`;
                        break;
                    case "animateZoom":
                        s += `--animate-zoom:${f};`;
                        break;
                    ...
                    case "backgroundColor":
                        "1" != _.get(i, "backgroundColor") && (a += `background-color:${f};`);
                        break;
                    case "backgroundGradient":
                        let u = _.get(i, "backgroundGradient")
                          , $ = _.get(i, "backgroundGradient1")
                          , m = _.get(i, "backgroundGradient2")
                          , g = _.get(i, "backgroundGradientRange1")
                          , b = _.get(i, "backgroundGradientRange2")
                          , w = "90deg";
                        "1" == _.get(i, "backgroundGradientWay") && (w = "180deg"),
                        null == g && (g = 0),
                        null == b && (b = 100),
                        "1" == u && (a += `background: linear-gradient(${w}, ${$} ${g}%, ${m} ${b}%);`);
                        break;
                    case "color":
                        a += `color:${f};`;
                        break;
                    ...
                    case "borderStyle":
                        let v = "solid";
                        if ("none" == _.get(i, "borderStyle"))
                            break;
                        "dotted" == _.get(i, "borderStyle") && (v = "dotted"),
                        "dashed" == _.get(i, "borderStyle") && (v = "dashed"),
                        "solid" == _.get(i, "borderStyle") && (v = "solid"),
                        "double" == _.get(i, "borderStyle") && (v = "double"),
                        "groove" == _.get(i, "borderStyle") && (v = "groove"),
                        "ridge" == _.get(i, "borderStyle") && (v = "ridge"),
                        "inset" == _.get(i, "borderStyle") && (v = "inset"),
                        "outset" == _.get(i, "borderStyle") && (v = "outset");
                        let y = "1";
                        _.get(i, "borderWidth") && (y = parseInt(_.get(i, "borderWidth")));
                        let k = "#000000";
                        _.get(i, "borderColor") && (k = _.get(i, "borderColor")),
                        a += `border: ${y}px ${k} ${v};`;
                        break;
                    case "textBorderWidth":
                        let x = "1";
                        _.get(i, "textBorderWidth") && (x = parseInt(_.get(i, "textBorderWidth")));
                        let C = "#000000";
                        _.get(i, "borderColor") && (C = _.get(i, "borderColor")),
                        a += `-webkit-text-stroke: ${x}px ${C};`,
                        a += `text-stroke: ${x}px ${C};`;
                        break;
                    case "borderRadius":
                        let z = "px";
                        "%" == _.get(i, "borderRadiusUnit") && (z = "%"),
                        f == parseInt(f) ? a += `border-radius:${f}${z};` : a += `border-radius:${f};`;
                        break;
                    case "shadowOpacity":
                        let T = 0;
                        if (_.get(i, "shadowOpacity") && (T = parseFloat(_.get(i, "shadowOpacity"))),
                        !T)
                            break;
                        let S = 0;
                        _.get(i, "shadowBlur") && (S = parseInt(_.get(i, "shadowBlur")));
                        let q = hexToRgbA("#000000", T);
                        _.get(i, "shadowColor") && (q = hexToRgbA(_.get(i, "shadowColor"), T));
                        let I = 0;
                        _.get(i, "shadowOfesetLeft") && (I = parseInt(_.get(i, "shadowOfesetLeft")));
                        let F = 0;
                        _.get(i, "shadowOfesetTop") && (F = parseInt(_.get(i, "shadowOfesetTop")));
                        let D = 0;
                        _.get(i, "shadowSpread") && (D = parseInt(_.get(i, "shadowSpread"))),
                        a += `box-shadow: ${I}px ${F}px ${S}px ${D}px ${q};`;
                        break;
                    case "fontFamily":
                        let L = '"' + (f = f.replace(";", "")).split(",").join('", "') + '"';
                        a += `font-family:${L};`;
                        break;
                    ...
                    case "btnBackgroundColor":
                        1 != _.get(i, "btnBackgroundColor") && (c += `background-color:${f};`);
                        break;
                    case "btnBackgroundGradient":
                        let O = _.get(i, "btnBackgroundGradient")
                          , H = _.get(i, "btnBackgroundGradient1")
                          , A = _.get(i, "btnBackgroundGradient2")
                          , B = _.get(i, "btnBackgroundGradientRange1")
                          , E = _.get(i, "btnBackgroundGradientRange2")
                          , M = "90deg";
                        "1" == _.get(i, "btnBackgroundGradientWay") && (M = "180deg"),
                        null == B && (B = 0),
                        null == E && (E = 100),
                        "1" == O && (c += `background: linear-gradient(${M}, ${H} ${B}%, ${A} ${E}%);`);
                        break;
                    case "btnColor":
                        c += `color:${f};`;
                        break;
                    case "backgroundHoverColor":
                        h += `background-color:${f};`;
                        break;
                    case "btnRadius":
                        let j = "px";
                        "%" == _.get(i, "borderRadiusUnit") && (j = "%"),
                        f == parseInt(f) ? c += `border-radius:${f}${j};` : c += `border-radius:${f};`
                    }
            }
            )),
            {
